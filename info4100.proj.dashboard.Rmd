...
* What? What data to show and what is its structure?
    ...
    + Structure: 
        Attendance Table: student ID, session date, attendance status
        Quiz Scores Table: student ID, quiz number, quiz score, session number
        Temperature Checks Table: student ID, session date, quiz score
        Skills Survey Table: student ID, skill area (e.g., SQL), self-rating (e.g., 1–5 scale)
...
* Why? What is the goal? What questions to answer?
    ...
    + Questions:
        ...
        "How much do the average quiz scores per student vary?"
        "How do graduate vs. undergraduate students perform?"
...
* What? What data to show and what is its structure?
    ...
    + Structure:
        Attendance Table: session number, session date, student ID, attendance
        Quiz Scores Table: student ID, quiz number, score
        Student Demographics Table: student ID, level (grad/undergrad), major
        Skills Table: student ID, skill area, rating
